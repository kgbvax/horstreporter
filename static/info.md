...
It is effectively an alternate frontend for [pskreporter](https://www.pskreporter.info). Made by DL9ET to discover SSB DX opportunities. 
...
If you are intrested in this approach, have a look at https://hf.dxview.org which follows the same approach (just more refined).
...
More information may be available in my blog: <https://dl9et.darc.de/tags/horstreporter/>
